...
- (void)startAnimating{
    switch (self.position) {
        case SVPullToRefreshPositionTop:
            ...
            if(fabs(self.scrollView.contentOffset.y) == self.originalTopInset) {
                [self.scrollView setContentOffset:CGPointMake(self.scrollView.contentOffset.x, -self.originalTopInset-self.frame.size.height) animated:YES];
